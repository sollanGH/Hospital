						...
						<div class="ibox-content">
							<form class="form-horizontal m-t" id="Formadd">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input id="deparmentName" name="deparmentName" minlength="1" type="text" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">科室位置：</label>
									<div class="col-sm-8">
										<input id="deparmentLocation"  name="deparmentLocation" type="text" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">科室描述：</label>
									<div class="col-sm-8">
										<input id="deparmentDescription" name="deparmentDescription" type="text"  class="form-control" >
									</div>
								</div>
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<form class="form-horizontal m-t" id="FormEdit">
								<input id="deparmentId1" name="deparmentId" minlength="1" type="hidden" class="form-control" >
								<div class="form-group">
									<label class="col-sm-3 control-label">科室名：</label>
									<div class="col-sm-8">
										<input id="deparmentName1" name="deparmentName" minlength="1" type="text" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">科室位置：</label>
									<div class="col-sm-8">
										<input id="deparmentLocation1"  name="deparmentLocation" type="text" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label">科室描述：</label>
									<div class="col-sm-8">
										<input id="deparmentDescription1" name="deparmentDescription" type="text"  class="form-control" >
									</div>
								</div>
								<input id="descriptionCreateTime1" name="descriptionCreateTime" type="text"  class="form-control" >
								<div class="modal-footer">
									<button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
			...
			var TableInit = function() {
				...
				oTableInit.Init = function() {
					$('#tb_departments').bootstrapTable({
						url: '/hhh/selectDeparmentAll', //请求后台的URL（*）
						method: 'get', //请求方式（*）
						...
						columns: [{
							...
							field: 'deparmentLocation',
							title: '科室位置'
						}, {
							field: 'deparmentDescription',
							title: '科室简介'
						},{
							field: 'descriptionCreateTime',
							title: '创建时间'
						},],
						//事件处理
				...
				oInit.Init = function() {
					...
					$(document).on('click', "#btn_edit",function(){
						...
						if (arrselectedData.length <= 0) {
	                    	...
	                    	$('#deparmentId1').val(row.deparmentId);
	                		$('#deparmentName1').val(row.deparmentName);
	                		$('#deparmentLocation1').val(row.deparmentLocation);
	                		$('#deparmentDescription1').val(row.deparmentDescription);
	                		$('#descriptionCreateTime1').val(row.descriptionCreateTime);
	                    	//console.log(row);
	                    }
						});
					//删除按钮

				...
				<div class="panel-body">
					<form id="formSearch" class="form-horizontal">
						<div class="form-group" style="margin-top:15px">
							<label class="control-label col-sm-1" for="txt_search_departmentname">科室</label>
							<div class="col-sm-3">
							...
							<label class="control-label col-sm-1" for="txt_search_statu">病房号</label>
							<div class="col-sm-3">
		...
		function getDeparmentlList() {//获取下拉科室列表
			...
			// 回调函数，接受服务器端返回给客户端的值，即result值
	            success: function (data) {
	            	$('#txt_search_departmentname.selectpicker').append("<option value=-1>请选择科室</option>");
			...
			var TableInit = function() {
				...
				oTableInit.Init = function() {
					$('#tb_departments').bootstrapTable({
						url: '/hospital/selectRoomAll', //请求后台的URL（*）
						method: 'get', //请求方式（*）
				...
				oTableInit.queryParams = function(params) {
					var param = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
						...
						room_name: $("#txt_search_statu").val(),

...
<body>
	<div class="panel-body" style="padding-bottom:0px;">
				...
				<div class="panel-body">
					<form id="formSearch" class="form-horizontal">
						...
						<div class="form-group" style="margin-top:15px">
                            ...
                            <div class="col-sm-1 form-group">
                                <input style="width: 260px;" type="hidden" id="time2" name="time2" 
                                	type="text" class="form-control"   >
                            </div>
						</div>
					</form>
		...
		<div id="toolbar" class="btn-group">
			<button id="btn_action" type="button" class="btn btn-white" >
	        	<span class="glyphicon glyphicon-pencil"></span>选择患者
	    	</button>
	   		<!-- <button id="btn_cancel" type="button" class="btn btn-white">
              	<span class="glyphicon glyphicon-remove" ></span>医嘱冲减
	          	</button> -->
    	</div>
    ...
    $().ready(function() {
        ...
        var end_time = $("#start_time").val() + " " + '23' + ":" + '59' + ":" + '59';
	...
	var TableInit = function() {
		...
		oTableInit.Init = function() {
			$('#tb_patient_message').bootstrapTable({
				url: '/hospital/selectAll_Payment_today_Patient_message', //请求后台的URL（*）
				method: 'get', //请求方式（*）
		...
		oTableInit.queryParams = function(params) {
			var param = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
				...
				select_deparment_id : "${USER.deparment_id}",
				start_ruyuan_time : $('#time1').val(),
				end_ruyuan_time : $('#time2').val(),
			};
			return param;
		};
		return oTableInit;
		...
		oInit.Init = function() {
			...
			$(document).on('click', "#btn_action",function(){
				...
				if (arrselectedData.length <= 0) {
                	...
                	turnnew();
					function turnnew(){
						page("Payment2_today?patient_id="+row.patient.patient_id+"&patient_name="+row.patient.patient_name
								+"&deparment_name="+row.deparment.deparment_name+"&room_name="+row.room.room_name
								+"&start_time="+$("#start_time").val()+ " " + '00' + ":" + '00' + ":" + '00',"住院日结");

...
<html>
	...
	<head>
	 ...
	 <body>
        ...
        <div class="panel-body" style="padding-bottom:0px; transform: translateY(-40px);">
        ...
        <div id = "tablea" >
        	...
        	<label class="mr-sm-2" for="inlineFormCustomSelect">检查结论</label>
   			 <textarea  readonly="readonly" style="resize:none" class="form-control" id="exampleFormControlTextarea1" rows="7"></textarea>
        </div>
        </div>
		...
		$(document).ready(function (){
			 ...
			 $.ajax({
					url: "/hospital/show_suggest_Inspection",
					type:"get",
					data:{
					 ...
					 success: function (data) {
		                ...
		                $('#exampleFormControlTextarea1').val(a);
			         },
			         error:function(){
			        	 alert("失败");
					 }
		...
		oInit.Init = function() {
			$(document).on('click', "#btn_check",function(){
				 ...
				 $.ajax({
						url: "/hospital/printf_select_Inspection_list",
						type:"post",
						data:{
							Inspection_id: "${inspection_id}",
						},

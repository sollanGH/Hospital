...
public class Medical_Orders {
	...
	public Medical_Orders(Integer medical_orders_id, String patient_id,
			Date start_time, Integer check_state, String doctor_id,
	...
	public String toString() {
		return "Medical_Orders [medical_orders_id=" + medical_orders_id
				+ ", patient_id=" + patient_id + ", start_time=" + start_time
				+ ", check_state=" + check_state + ", doctor_id=" + doctor_id

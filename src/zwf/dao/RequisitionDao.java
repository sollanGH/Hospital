...
public interface RequisitionDao {
	...
	public int addRequisition_message(Requisition requisition);
	
	public int countRequisition_message(Requisition requisition);
	
	public int showRequisition_message_Id(Requisition requisition);

...
import com.itextpdf.text.pdf.PdfWriter;
	 ...
	 *
	 */
	public class Printf_Medicines {


	    /**
	     * @throws Exception
	     */
	    public void addTable(String path,ZGLSZBean_Medicines zBean) throws Exception{
	        ...
	        Rectangle rectangle = new Rectangle(PageSize.A5); //设置纸张的大小对象
	        ...
	        //设置页眉页脚
	        Rectangle rect = new Rectangle(10, 20, 260, 394);
	        ...
	        //设置各列的列宽  
	        table.setTotalWidth(new float[]{100,100,100,100,100,100,100,100}); 
	        ...
	        cell=mergeCol(zBean.getSncode(), font, 1); 
	        ...
	        cell=mergeCol(zBean.getSpname(), font, 1); 
	        ...
	        //--1
	        //姓名：
	        PdfPCell pdfCell_dwmc = getPDFCell("申请时间:",font);
	        ...
	        //性别：
	        PdfPCell pdfCell_zgzh = getPDFCell("发药人:",font);
	        pdfCell_zgzh.setBorder(Rectangle.NO_BORDER);
	        //table.addCell(pdfCell_zgzh); 
	        /*cell=mergeCol(zBean.getSpcode(), font, 1); 
	        cell.setBorder(Rectangle.NO_BORDER);
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell);  */
	        ...
	        //住院号：
	        PdfPCell pdfCell_sjfw = getPDFCell("领药人:",font);
	        pdfCell_sjfw.setBorder(Rectangle.NO_BORDER);
	        /*table.addCell(pdfCell_sjfw); 
	        cell=mergeCol(zBean.getRqfw(), font, 1); 
	        cell.setBorder(Rectangle.NO_BORDER);
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell);  */
	        ...
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell); */
	        PdfPCell pdfCell_dysjj = getPDFCell(" ",font);
	        pdfCell_dysjj.setBorder(Rectangle.NO_BORDER);
	        //--3
	        PdfPCell mergeRow_sj = mergeCol("药品名称", font, 2);
	        mergeRow_sj.setRowspan(2);
	        table.addCell(mergeRow_sj);
	        PdfPCell mergeRow_cllx = mergeCol("规格", font, 2);
	        mergeRow_cllx.setRowspan(2);
	        table.addCell(mergeRow_cllx);
	        PdfPCell mergeRow_hjny = mergeCol("数量", font, 2);
	        mergeRow_hjny.setRowspan(2);
	        table.addCell(mergeRow_hjny);
	        PdfPCell mergeRow_sr = mergeCol("单位", font, 2);
	        mergeRow_sr.setRowspan(2);
	       ...
	       /* PdfPCell pdfCell_gjj = getPDFCell("支出",font);
	        ...
	        for (Map<String, Object> item_map : zBean.getArray_list()) {
	        	...
	        	table.addCell(mergeCol(isNull(item_map.get("KSRQ")), font,2));
	            table.addCell(mergeCol(isNull(item_map.get("YZNR")), font,2)); 
	            table.addCell(mergeCol(isNull(item_map.get("ZSQZ")), font,2));
	            table.addCell(mergeCol(isNull(item_map.get("HSQZ")), font,2));
	        ...
	        table.addCell(pdfCell_sjfw); 
	        cell=mergeCol(zBean.getAbcd(), font, 1); 
	        cell.setBorder(Rectangle.NO_BORDER);
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell); 
	        
	        table.addCell(pdfCell_dysj); 
	        cell=mergeCol(zBean.getSpcode(), font, 4); 
	        cell.setBorder(Rectangle.NO_BORDER);
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell); 
	        
	        /*table.addCell(pdfCell_dysjj); 
	        cell=mergeCol(" ", font, 1); 
	        cell.setBorder(Rectangle.NO_BORDER);
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell); */
	        ...
	        //文档写入内容  
	        doc.open();  
	        Paragraph title=new Paragraph("领药单",font1);  
	     ...
	     *
	     */
	    public static class ZGLSZBean_Medicines{

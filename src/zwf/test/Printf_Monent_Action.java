...
import com.itextpdf.text.pdf.PdfWriter;
	 ...
	 *
	 */
	public class Printf_Monent_Action {


	    /**
	     * @throws Exception
	     */
	    public void addTable(String path,ZGLSZBean_Monent_Action zBean) throws Exception{
	        ...
	        PdfPCell mergeRow_cllx = mergeCol("医嘱内容", font, 7);
	        ...
	        PdfPCell mergeRow_sr = mergeRow("执行时间", font, 2);
	        table.addCell(mergeRow_sr);
	        PdfPCell mergeCol_zc = mergeRow("执行护士", font, 2);
	       ...
	       /* PdfPCell pdfCell_gjj = getPDFCell("支出",font);
	        ...
	        for (Map<String, Object> item_map : zBean.getArray_list()) {
	            ...
	            table.addCell(mergeCol(isNull(item_map.get("YZNR")), font,7)); 
	        ...
	        //文档写入内容  
	        doc.open();  
	        Paragraph title=new Paragraph("临时医嘱执行单",font1);  
	     ...
	     *
	     */
	    public static class ZGLSZBean_Monent_Action{

...
import com.itextpdf.text.pdf.PdfWriter;
	 ...
	 *
	 */
	public class Printf_Long {


	    /**
	     * @throws Exception
	     */
	    public void addTable(String path,ZGLSZBean_Long zBean) throws Exception{
	        ...
	        cell=mergeCol(zBean.getSnname(), font, 1); 
	        ...
	        //--3
	        PdfPCell mergeRow_sj = mergeRow("开始日期", font, 2);
	        table.addCell(mergeRow_sj);
	        PdfPCell mergeRow_cllx = mergeCol("医嘱内容", font, 4);
	        mergeRow_cllx.setRowspan(2);
	        table.addCell(mergeRow_cllx);
	        PdfPCell mergeRow_hjny = mergeRow("下嘱医生", font, 2);
	        table.addCell(mergeRow_hjny);
	        PdfPCell mergeRow_dwmc = mergeRow("核对时间", font, 2);
	        table.addCell(mergeRow_dwmc);
	        PdfPCell mergeRow_sr = mergeRow("核对护士", font, 2);
	        table.addCell(mergeRow_sr);
	        PdfPCell mergeCol_zc = mergeRow("停止时间", font, 2);
	       ...
	       /* PdfPCell pdfCell_gjj = getPDFCell("支出",font);
	        ...
	        for (Map<String, Object> item_map : zBean.getArray_list()) {
	            ...
	            table.addCell(mergeCol(isNull(item_map.get("YZNR")), font,4)); 
	            table.addCell(getPDFCell(isNull(item_map.get("ZSQZ")), font));
	            table.addCell(getPDFCell(isNull(item_map.get("HDSJ")), font));
	            table.addCell(getPDFCell(isNull(item_map.get("HSQZ")), font));
	            table.addCell(getPDFCell(isNull(item_map.get("TZSJ")), font));
	        ...
	        //文档写入内容  
	        doc.open();  
	        Paragraph title=new Paragraph("长期医嘱单",font1);  
	     ...
	     *
	     */
	    public static class ZGLSZBean_Long{

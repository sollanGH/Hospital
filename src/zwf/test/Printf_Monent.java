...
import com.itextpdf.text.pdf.PdfWriter;
	 ...
	 *
	 */
	public class Printf_Monent {


	    /**
	     * @throws Exception
	     */
	    public void addTable(String path,ZGLSZBean_Monent zBean) throws Exception{
	        ...
	        PdfPCell mergeRow_cllx = mergeCol("医嘱内容", font, 6);
	        ...
	        PdfPCell mergeCol_zc = mergeRow("核对时间", font, 2);
	       ...
	       /* PdfPCell pdfCell_gjj = getPDFCell("支出",font);
	        ...
	        for (Map<String, Object> item_map : zBean.getArray_list()) {
	            ...
	            table.addCell(mergeCol(isNull(item_map.get("YZNR")), font,6)); 
	        ...
	        //文档写入内容  
	        doc.open();  
	        Paragraph title=new Paragraph("临时医嘱单",font1);  
	     ...
	     *
	     */
	    public static class ZGLSZBean_Monent{

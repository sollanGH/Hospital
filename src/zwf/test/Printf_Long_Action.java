...
import com.itextpdf.text.pdf.PdfWriter;
	 ...
	 *
	 */
	public class Printf_Long_Action {


	    /**
	     * @throws Exception
	     */
	    public void addTable(String path,ZGLSZBean_Long_Action zBean) throws Exception{
	        ...
	        cell=mergeCol(zBean.getRqfw(), font, 2); 
	        cell.setBorder(Rectangle.NO_BORDER);
	        cell.setHorizontalAlignment(Element.ALIGN_LEFT);
	        table.addCell(cell);  
	        ...
	        PdfPCell mergeRow_cllx = mergeCol("医嘱内容", font, 5);
	        ...
	        PdfPCell mergeRow_dwmc = mergeRow("执行时间", font, 2);
	        table.addCell(mergeRow_dwmc);
	        PdfPCell mergeRow_sr = mergeRow("执行护士", font, 2);
	       ...
	       /* PdfPCell pdfCell_gjj = getPDFCell("支出",font);
	        ...
	        for (Map<String, Object> item_map : zBean.getArray_list()) {
	            ...
	            table.addCell(mergeCol(isNull(item_map.get("YZNR")), font,5)); 
	        ...
	        //文档写入内容  
	        doc.open();  
	        Paragraph title=new Paragraph("长期医嘱执行单",font1);  
	     ...
	     *
	     */
	    public static class ZGLSZBean_Long_Action{
